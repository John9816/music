...
/**
 * MediaSession-facing player that keeps queue skip wired through [PlaybackCoordinator]
 * while preserving full metadata (title / artwork / duration) for the system media panel.
 */
@UnstableApi
